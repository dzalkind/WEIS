------- OpenFAST INPUT FILE ------------------------------------------- 
"IEA"        MW Floating Offshore Reference Turbine, preliminary OpenFAST model for design iteration version 4.0, 10/11/2019 
---------------------- SIMULATION CONTROL -------------------------------------- 
False         Echo        - Echo input data to <RootName>.ech (flag) 
"FATAL"       AbortLevel  - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"} 
       850    TMax        - Total run time (s) 
...
---------------------- INPUT FILES --------------------------------------------- 
"NASA_Float_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"NASA_Float_InflowFile.dat"    InflowFile.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string) 
"NASA_Float_AeroDyn15.dat"    AeroFile     - Name of file containing aerodynamic input parameters (quoted string) 
"NASA_Float_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string) 
"NASA_Float_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"NASA_Float_MoorDyn.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string) 
