...
def run_DLC():
    ...
    cut_in                  = 6.    # Cut in wind speed
    cut_out                 = 24.   # Cut out wind speed
    n_ws                    = 6    # Number of wind speed bins
    TMax                    = 700.    # Length of wind grids and OpenFAST simulations, suggested 720 s
    ...
    case_inputs[("Fst","DT")]                = {'vals':[0.0125], 'group':0}
