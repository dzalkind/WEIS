...
def simp_step(discon_file,runDir, namebase,rosco_dll='',tune=''):
    ...
    if tune == 'fl_gain':
        ...
        case_inputs[('DISCON_in','Fl_Kp')] = {'vals': [-250.035,-114.558,-67.141,-45.194,-33.272,-26.084,-21.418,-18.219,-15.931,-14.238,-12.951,-11.949,-11.154,-10.512,-9.987,-9.552,-9.188,-8.879,-8.616,-8.389,-8.192,-8.021,-7.870,-7.738,-7.620,-7.515,-7.421,-7.337,-7.261,-7.192,-7.130,-7.073,-7.021,-6.973,-6.930,-6.890,-6.852,-6.818,-6.787], 'group': 2}
        case_inputs[('DISCON_in','F_FlCornerFreq')] = {'vals': [0.020,0.030,0.040,0.050,0.060,0.070,0.080,0.090,0.100,0.110,0.120,0.130,0.140,0.150,0.160,0.170,0.180,0.190,0.200,0.210,0.220,0.230,0.240,0.250,0.260,0.270,0.280,0.290,0.300,0.310,0.320,0.330,0.340,0.350,0.360,0.370,0.380,0.390,0.400], 'group': 2}
        # case_inputs[('DISCON_in','F_FlHighPassFreq')] = {'vals':[0.001,0.005,0.010,0.020,0.030,0.042,0.060,0.100], 'group': 2}
        case_inputs[('meta','phase_30')] = {'vals':[-76.357,-70.963,-65.641,-60.412,-55.295,-50.305,-45.456,-40.758,-36.221,-31.848,-27.645,-23.610,-19.745,-16.046,-12.511,-9.135,-5.912,-2.839,0.092,2.887,5.551,8.091,10.513,12.824,15.028,17.132,19.141,21.060,22.893,24.647,26.324,27.930,29.468,30.941,32.354,33.709,35.010,36.260,37.461],'group':2}
        case_inputs[('meta','phase_50')] = {'vals':[-67.364,-58.596,-50.137,-42.056,-34.404,-27.211,-20.487,-14.230,-8.426,-3.055,1.908,6.493,10.728,14.640,18.258,21.606,24.710,27.590,30.266,32.757,35.080,37.249,39.277,41.177,42.959,44.633,46.209,47.693,49.094,50.418,51.670,52.856,53.981,55.050,56.065,57.032,57.952,58.830,59.669],'group':2}
        ...
        zeta  = np.linspace(1,3,5,endpoint=True).tolist()
        
        control_case_inputs = sweep_pc_mode(control_param_yaml,omega,zeta)
