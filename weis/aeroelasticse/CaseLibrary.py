...
def simp_step(discon_file,runDir, namebase,rosco_dll='',tune=''):
    ...
    if tune == 'fl_gain':
        case_inputs[('DISCON_in','Fl_Kp')] = {'vals': np.linspace(0,-40,20,endpoint=True).tolist(), 'group': 2}

    elif tune == 'fl_phase':
        case_inputs[('DISCON_in','Fl_Kp')] = {'vals': [-250.035,-67.141,-33.272,-21.418,-15.931,-12.951,-11.154,-9.987,-9.188,-8.616,-8.192,-7.870,-7.620,-7.421,-7.261,-7.130,-7.021,-6.930,-6.852,-6.787], 'group': 2}
        case_inputs[('DISCON_in','F_FlCornerFreq')] = {'vals': [0.020,0.040,0.060,0.080,0.100,0.120,0.140,0.160,0.180,0.200,0.220,0.240,0.260,0.280,0.300,0.320,0.340,0.360,0.380,0.400], 'group': 2}
        # case_inputs[('DISCON_in','F_FlHighPassFreq')] = {'vals':[0.001,0.005,0.010,0.020,0.030,0.042,0.060,0.100], 'group': 2}
        case_inputs[('meta','phase_30')] = {'vals':[-76.357,-65.641,-55.295,-45.456,-36.221,-27.645,-19.745,-12.511,-5.912,0.092,5.551,10.513,15.028,19.141,22.893,26.324,29.468,32.354,35.010,37.461],'group':2}
        case_inputs[('meta','phase_50')] = {'vals':[-67.364,-50.137,-34.404,-20.487,-8.426,1.908,10.728,18.258,24.710,30.266,35.080,39.277,42.959,46.209,49.094,51.670,53.981,56.065,57.952,59.669],'group':2}
