...
class InputWriter_OpenFAST(InputWriter_Common):
    ...
    def write_DISCON_in(self):
        ...
        try:
            ...
            turbine.ptfm_freq               = self.fst_vt['DISCON_in']['F_FlCornerFreq']
    ...
    def write_HydroDyn(self):
        ...
        f.write('{:<22} {:<11} {:}'.format('"'+self.fst_vt['HydroDyn']['TMDFile']+'"', 'TMDFile', '- TMD Input File name\n'))
        f.write('{:<22} {:<11} {:}'.format('"'+self.fst_vt['HydroDyn']['TMDControlFile']+'"', 'TMDControlFile', '- TMD Control Input File name\n'))
