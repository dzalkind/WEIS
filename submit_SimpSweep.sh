...
#SBATCH --output=/scratch/dzalkind/job_SimpSweep_fl_phase.%j.out
...
module load mkl cmake
module load gcc/7.4.0 intel-parallel-studio/cluster.2018.4
conda activate weis-env3


python /scratch/dzalkind/WEIS-3/examples/aeroelasticse/run_SimpSweep_phase.py
